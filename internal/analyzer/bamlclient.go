...
func (c *BAMLLiveClient) AnalyzeCode(ctx context.Context, code string, policies string) ([]Finding, error) {
	...
	case "anthropic":
		results, err = c.analyzeWithAnthropic(ctx, code, policies)
	case "bedrock":
		results, err = c.analyzeWithBedrock(ctx, code, policies)
	case "openai":
		results, err = c.analyzeWithOpenAI(ctx, code, policies)
	default:
...
func (c *BAMLLiveClient) analyzeWithAnthropic(ctx context.Context, code string, policies string) ([]types.Finding, error) {
...
func (c *BAMLLiveClient) analyzeWithBedrock(ctx context.Context, code string, policies string) ([]types.Finding, error) {
...
func (c *BAMLLiveClient) analyzeWithOpenAI(ctx context.Context, code string, policies string) ([]types.Finding, error) {
